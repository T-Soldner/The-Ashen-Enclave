...
private _content =
	...
	"<font color='#D6B85A'>Sniper - 5 points</font><br/>DLT-19X, 773, IQA, Galaar-90, DC-15X, NT-242, LW-7, Westar Sniper<br/><br/>" +
	...
	"<font color='#D6B85A'>CSW - 9 points</font><br/>Mortar, E-Web, Autonomous AA Turret, Autonomous AT Turret<br/><br/>" +
